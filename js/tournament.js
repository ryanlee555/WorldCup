...
const MATCHES = [
  ...
  { id:"r32-1", round:"R32", date:"JUN 30", a:"fra", b:"swe", sa:3, sb:0, status:"played", venue:"NEW YORK NEW JERSEY STADIUM",
    d:{ goals:[{t:"fra",p:"Mbappé",m:45},{t:"fra",p:"Barcola",m:53},{t:"fra",p:"Mbappé",m:74}],
        stats:{pos:[53,38],sh:[25,8],sot:[12,3]}, motm:{t:"fra",p:"Kylian Mbappé"},
  ...
  { id:"r32-2", round:"R32", date:"JUN 29", a:"ger", b:"par", sa:1, sb:1, status:"played", note:"UPSET OF THE CUP · PARAGUAY WIN 4-3 ON PENS", venue:"PHILADELPHIA STADIUM",
    d:{ goals:[{t:"par",p:"Enciso",m:42},{t:"ger",p:"Havertz",m:54}], pens:"Paraguay won 4-3 on penalties",
        stats:{pos:[65,23],sh:[21,7],sot:[6,3]}, motm:{t:"par",p:"Orlando Gill (GK)"},
  ...
  { id:"r32-3", round:"R32", date:"JUN 29", a:"ned", b:"mar", sa:1, sb:1, status:"played", note:"MOROCCO WIN 3-2 ON PENS", venue:"BOSTON STADIUM",
    d:{ goals:[{t:"ned",p:"Gakpo",m:72},{t:"mar",p:"Issa Diop",m:91}], pens:"Morocco won 3-2 on penalties",
        stats:{pos:[31,61],sh:[6,11],sot:[2,5]}, motm:{t:"mar",p:"Yassine Bounou (GK)"},
  ...
  { id:"r32-4", round:"R32", date:"JUN 28", a:"rsa", b:"can", sa:0, sb:1, status:"played", venue:"LOS ANGELES STADIUM",
    d:{ goals:[{t:"can",p:"Eustáquio",m:92}], stats:{pos:[null,null],sh:[null,null],xg:[0.13,1.32]},
  ...
  { id:"r32-5", round:"R32", date:"JUL 2", a:"por", b:"cro", sa:2, sb:1, status:"played", note:"RAMOS 90+4' WINNER · MODRIĆ FAREWELL", venue:"TORONTO STADIUM",
    d:{ goals:[{t:"cro",p:"Perišić",m:53},{t:"por",p:"Ronaldo",m:68,pen:true},{t:"por",p:"Gonçalo Ramos",m:94}],
        stats:{pos:[55,37],sh:[15,13],sot:[3,6]}, motm:{t:"por",p:"Gonçalo Ramos"},
  ...
  { id:"r32-6", round:"R32", date:"JUL 2", a:"esp", b:"aut", sa:3, sb:0, status:"played", note:"OYARZABAL ×2", venue:"LOS ANGELES STADIUM",
    d:{ goals:[{t:"esp",p:"Oyarzabal",m:36},{t:"esp",p:"Porro",m:66},{t:"esp",p:"Oyarzabal",m:89}],
        stats:{pos:[null,null],sh:[null,null]}, motm:{t:"esp",p:"Mikel Oyarzabal"},
  ...
  { id:"r32-7", round:"R32", date:"JUL 1", a:"usa", b:"bih", sa:2, sb:0, status:"played", note:"BALOGUN RED CARD 64'", venue:"SAN FRANCISCO BAY AREA STADIUM",
    d:{ goals:[{t:"usa",p:"Balogun",m:45},{t:"usa",p:"Tillman",m:82}], cards:[{t:"usa",p:"Balogun",m:64,c:"R"}],
        stats:{pos:[null,null],sh:[null,null]}, motm:{t:"usa",p:"Malik Tillman"},
  ...
  { id:"r32-8", round:"R32", date:"JUL 1", a:"bel", b:"sen", sa:3, sb:2, status:"played", note:"AET — TIELEMANS' 125' PEN IS THE LATEST GOAL IN WC HISTORY", venue:"SEATTLE STADIUM",
    d:{ goals:[{t:"sen",p:"Diarra",m:25},{t:"sen",p:"Ismaïla Sarr",m:52},{t:"bel",p:"Lukaku",m:86},{t:"bel",p:"Tielemans",m:89},{t:"bel",p:"Tielemans",m:125,pen:true}],
        stats:{pos:[48,42],sh:[19,19],sot:[5,5]}, motm:{t:"bel",p:"Youri Tielemans"},
  ...
  { id:"r32-9", round:"R32", date:"JUN 30", a:"civ", b:"nor", sa:1, sb:2, status:"played", note:"LATE HAALAND WINNER", venue:"KANSAS CITY STADIUM",
    d:{ goals:[{t:"nor",p:"Nusa",m:39},{t:"civ",p:"Amad Diallo",m:74},{t:"nor",p:"Haaland",m:86}],
        stats:{pos:[null,null],sh:[null,null],xg:[1.36,2.02]}, motm:{t:"nor",p:"Erling Haaland"},
  ...
  { id:"r32-10", round:"R32", date:"JUN 29", a:"bra", b:"jpn", sa:2, sb:1, status:"played", note:"MARTINELLI 96' WINNER", venue:"KANSAS CITY STADIUM",
  ...
  { id:"r32-11", round:"R32", date:"JUL 1", a:"eng", b:"cod", sa:2, sb:1, status:"played", note:"KANE LATE DOUBLE", venue:"MIAMI STADIUM",
    d:{ goals:[{t:"cod",p:"Brian Cipenga",m:7},{t:"eng",p:"Kane",m:75},{t:"eng",p:"Kane",m:86}],
        stats:{pos:[null,null],sh:[null,null]}, motm:{t:"eng",p:"Harry Kane"},
  ...
  { id:"r32-12", round:"R32", date:"JUN 30", a:"mex", b:"ecu", sa:2, sb:0, status:"played", note:"MEXICO BREAK A 40-YEAR KNOCKOUT DROUGHT", venue:"MEXICO CITY (AZTECA)",
    d:{ goals:[{t:"mex",p:"Quiñones",m:22},{t:"mex",p:"Raúl Jiménez",m:31}], stats:{pos:[null,null],sh:[null,null]},
  ...
  { id:"r32-13", round:"R32", date:"JUL 3", a:"arg", b:"cpv", sa:3, sb:2, status:"played", note:"AET — CHAMPIONS SURVIVE A HUGE SCARE", venue:"MIAMI STADIUM",
    d:{ goals:[{t:"arg",p:"Messi",m:29},{t:"cpv",p:"Deroy Duarte",m:58},{t:"arg",p:"Lisandro Martínez",m:91},{t:"cpv",p:"Lopes Cabral",m:103},{t:"cpv",p:"Diney Borges",m:111,og:true}],
        stats:{pos:[null,null],sh:[null,null]}, motm:{t:"arg",p:"Lionel Messi"},
  ...
  { id:"r32-14", round:"R32", date:"JUL 1", a:"aus", b:"egy", sa:1, sb:1, status:"played", note:"EGYPT WIN 4-2 ON PENS", venue:"DALLAS STADIUM",
    d:{ goals:[{t:"egy",p:"Emam Ashour",m:13},{t:"egy",p:"Mohamed Hany",m:55,og:true}], pens:"Egypt won 4-2 on penalties (Souttar and Herrington missed for Australia)",
        stats:{pos:[35,53],sh:[16,14],sot:[2,4]}, motm:{t:"egy",p:"Mohamed Salah"},
  ...
  { id:"r32-15", round:"R32", date:"JUL 3", a:"sui", b:"alg", sa:2, sb:0, status:"played", note:"NDOYE'S 45+1' GOAL — FASTEST 2ND-HALF WC KNOCKOUT GOAL SINCE 1998", venue:"HOUSTON STADIUM",
  ...
  { id:"r32-16", round:"R32", date:"JUL 3", a:"col", b:"gha", sa:1, sb:0, status:"played", venue:"KANSAS CITY STADIUM",
    d:{ goals:[{t:"col",p:"Jhon Arias",m:14}], stats:{pos:[61,39],sh:[18,8],sot:[7,0],xg:[2.06,0.26]},
  ...
  /* Round of 16 — Jul 4–7 */
  { id:"r16-1", round:"R16", date:"JUL 4", a:"fra", b:"par", sa:1, sb:0, status:"played", venue:"PHILADELPHIA STADIUM",
    d:{ goals:[{t:"fra",p:"Mbappé",m:70,pen:true}], stats:{pos:[76,24],sh:[15,5],sot:[5,0]}, motm:{t:"fra",p:"Kylian Mbappé"},
  ...
  { id:"r16-2", round:"R16", date:"JUL 4", a:"can", b:"mar", sa:0, sb:3, status:"played", venue:"HOUSTON STADIUM",
  ...
  { id:"r16-3", round:"R16", date:"JUL 5", a:"mex", b:"eng", sa:2, sb:3, status:"played", note:"BELLINGHAM ×2 IN 98 SECONDS · KANE PEN · QUANSAH RED", venue:"MEXICO CITY (AZTECA)",
    d:{ goals:[{t:"eng",p:"Bellingham",m:36},{t:"eng",p:"Bellingham",m:38},{t:"mex",p:"Quiñones",m:42},{t:"eng",p:"Kane",m:60,pen:true},{t:"mex",p:"Raúl Jiménez",m:69,pen:true}],
        cards:[{t:"eng",p:"Quansah",m:52,c:"R"}], stats:{pos:[61,39],sh:[9,4],sot:[3,3]}, motm:{t:"eng",p:"Jude Bellingham"},
        sum:"Bellingham scored twice in 98 seconds — the first World Cup brace at the Azteca since Maradona in '86. Mexico actually out-possessed and out-shot England, but the Three Lions survived 40+ minutes a man down after Quansah's red card to win an instant classic." } },
  { id:"r16-4", round:"R16", date:"JUL 5", a:"bra", b:"nor", sa:1, sb:2, status:"played", note:"HAALAND BRACE 79' 90' — BRAZIL OUT!", venue:"NEW YORK NEW JERSEY STADIUM",
    d:{ goals:[{t:"nor",p:"Haaland",m:79},{t:"nor",p:"Haaland",m:90},{t:"bra",p:"Neymar",m:100,pen:true}],
        stats:{pos:[66,34],sh:[9,5]}, motm:{t:"nor",p:"Erling Haaland"},
        sum:"Brazil had 66% possession and dominated for long stretches, but Haaland's brace — plus a masterclass from keeper Ørjan Nyland — sent Norway to their first-ever World Cup quarterfinal. Neymar's stoppage-time penalty, possibly his final act for the Seleção, arrived too late." } },
